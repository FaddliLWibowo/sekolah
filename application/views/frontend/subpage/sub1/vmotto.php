<div class="content">
    ...
    <div class="center_all" style="width: 70%;min-height: 384px">
        ...
        <ol>
            ...
            <li>Menanamkan disiplin yang tinggi yang ditunjang oleh kondisi fisik yang prima</li>
            <li>Menanamkan semangat nasionalisme dan patriotisme</li>
            <li>Mengarahkan siswa agar memiliki kepekaan sosial dan kepemimpinan.</li>
            <li>Mengembangkan wawasan IPTEK yang mendalam dan luas.</li>
            <li>Menumbuhkan motivasi dan komitmen yang tinggi untuk mencapai prestasi dan keunggulan dalam setiap ajang kompetisi.</li>
            <li>Melaksanakan pembelajaran dan bimbingan secara efektif, efisien dan berkesinambungan.</li>
